...
class HtmlOutput:
        ...
        for roomId in range(nr):
            ...
            for periodId in range(HtmlOutput.ROOM_ROW_NUMBER):
                if periodId == 0:
                    ...
                    sb.append("<table style=' border-collapse: collapse; text-align: center; width: 100%'>\n")
    ...
    def getTableHeader(room):
        sb = ["<tr><th style='color:#00008B; border: 1000em solid black' scope='col' colspan='2'>Room: ", room.Name, "</th>\n"]
